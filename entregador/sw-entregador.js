...
messaging.onBackgroundMessage(function(payload) {
  ...
  const notificationOptions = {
    ...
    icon: payload.data.icon || '../img/logos/logo-entregador.png',
    vibrate: [200, 100, 200, 100, 200],
    sound: '../audio/notification-entrega.mp3',
    tag: 'nova-entrega-ditalia'
  };
...
const CACHE_NAME = 'ditalia-entregador-cache-v101'; // Versão incrementada
const URLS_TO_CACHE = [
  './',
  './login.html',
  './app-entregador.html',
